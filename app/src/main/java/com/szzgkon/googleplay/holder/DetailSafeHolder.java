...
public class DetailSafeHolder extends BaseHolder<AppInfo> implements View.OnClickListener {
    ...
    public void refreshView(AppInfo data) {
        ...
        List<Integer> safeDesColor = data.getSafeDesColor();
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animator) {
                    int value = (Integer) animator.getAnimatedValue();//运行当前时间点的一个值
                       ...
                       safe_content.getLayoutParams().height = value;
    ...
    public int getMesureHeight(){
        int width = safe_content.getMeasuredWidth();//由于宽度不会发生变化，宽度的值直接取出来
